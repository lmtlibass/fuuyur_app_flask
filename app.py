...
def edit_artist_submission(artist_id):
  ...
  if form.validate_on_submit():
    ...
    flash('An error occurred. Artist ' + request.form['name'] + ' update failed!')
    return render_template('forms/edit_artist.html', form=form, artist=form.data)
...
def edit_venue_submission(venue_id):
  ...
  if form.validate_on_submit():
    ...
    flash('An error occurred. Venue ' + request.form['name'] + ' update failed!')
    return render_template('forms/edit_venue.html', form=form, venue=form.data)
#  Create Artist
#  ----------------------------------------------------------------
